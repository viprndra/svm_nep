...
namespace SVMST_PG_COLLEGE_Mvc.Models
{
	...
	public   class SqlHelper
    {
		...
		public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
		{
			...
			if ((parameterValues != null) && (parameterValues.Length > 0)) 
			{
				...
				SqlParameter[] commandParameters = SqlHelperParameterCache1.GetSpParameterSet(connectionString, spName);
		...
		public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
		{
			...
			{
				//pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
				SqlParameter[] commandParameters = SqlHelperParameterCache1.GetSpParameterSet(connection.ConnectionString, spName);
		...
		public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
		{
			...
			{
				//pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
				SqlParameter[] commandParameters = SqlHelperParameterCache1.GetSpParameterSet(transaction.Connection.ConnectionString, spName);
    ...
    //        /// dt = (DataTable)HttpContext.Current.Application["ProvideriD"];

    //        ///  System.Collections.Generic.List<clsGetProvider> lstAllCon = new System.Collections.Generic.List<clsGetProvider>();

    //        if (ds.Tables[0].Rows.Count > 0)
    //        {
    //            ConnStr = ds.Tables[0].Rows[0]["ConnectionString"].ToString();
    //            /// clsobjGetValue.Provider = ConnStr.ToString();

    //            /// HtApplication["ProvideriD"] = storeData((List<clsGetProvider>)Application["ProvideriD"], Convert.ToString(ProviderID));
    //            //for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
    //            //{
    //            //    clsGetProvider clsobjGetValue = new clsGetProvider();
    //            //    clsobjGetValue.Provider = ds.Tables[0].Rows[i]["ConnectionString"].ToString();
    //            //    clsobjGetValue.ProviderID = ds.Tables[0].Rows[i]["ProviderID"].ToString();

    //            //    lstGetProvider.Add(clsobjGetValue);
    //            //}

    //            //string sa= HttpContext.Current.Session["Check"].ToString();
    //            //lstPatientList_ASMX1 = lstGetProvider.FindAll(delegate(clsGetProvider tmpobj) { return (tmpobj.ProviderID.ToLower() == });
    //            //HttpContext.Current.Application["ProvideriD"] = lstPatientList_ASMX1;
    //            //ConnStr = lstPatientList_ASMX1[0].Provider.ToString();
    ...
    //}
        ...
        {
            string sqlcon = System.Configuration.ConfigurationManager.ConnectionStrings["IportexEMConnectionString"].ConnectionString;
            ...
            try
            {
                ...
                cn.Open();
                SqlCommand sql = new SqlCommand("select * from IE_Database_Setting where ProviderID='" + HttpContext.Current.Session["Check"].ToString() + "'", cn);
	...
	/// <summary>
	/// SqlHelperParameterCache1 provides functions to leverage a static cache of procedure parameters, and the
	...
	public sealed class SqlHelperParameterCache1
	{
		...
		//Since this class provides only static methods, make the default constructor private to prevent 
		//instances from being created with "new SqlHelperParameterCache1()".
